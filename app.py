...
def process_inputs(audio_filepath, image_filepath):
    ...
    if image_filepath:
        FMF_response = analyze_image_with_query(query=system_prompt+speech_to_text_output, encoded_image=encode_image(image_filepath), model="meta-llama/llama-4-scout-17b-16e-instruct")
    else:
        FMF_response = "No image provided for me to analyze"

    voice_of_FMF = text_to_speech_with_elevenlabs(input_text=FMF_response, output_filepath="final.mp3") 
